...
## Stage 4. Outlier treatment by columns
...
Method: clip to [0, 2.0423463344905035]
...
Method: clip to [-0.4829697396199859, 0.7142857142857143]
...
Method: clip to [-0.4666666666666667, 0.7974369156945476]
...
## Stage 4. Balance sheet normalization

After individual outlier treatment, the accounting identity `Equity/Assets + Liabilities/Assets = 1` was violated.

- Mean deviation before normalization: 0.023483
- Max deviation before normalization: 2.042346

**Solution:** Both ratios were divided by their sum.
...
For all added years, financial indicators were filled using the last available value from previous years.

**Result:** 0 missing values remaining in financial indicators.

**Note:** Default flags were not forward-filled. Only actual reporting years contain default information.
